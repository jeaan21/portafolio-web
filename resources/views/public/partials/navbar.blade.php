<header id="navbar" class="fixed top-0 left-0 right-0 z-50 transition-all duration-500 bg-transparent">
  ...
  <nav class="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 h-20 sm:h-24 flex items-center justify-between">
    ...
    <div class="hidden md:flex items-center gap-10">
      ...
      <button type="button" id="theme-toggle" class="relative w-11 h-11 rounded-2xl bg-white dark:bg-slate-900 shadow-sm ring-1 ring-slate-200 dark:ring-slate-800 flex items-center justify-center text-slate-600 dark:text-slate-400 hover:ring-blue-500 transition-all duration-300" aria-label="Toggle theme">
    ...
    <div class="flex md:hidden items-center gap-4">
      <button type="button" id="theme-toggle-mobile" class="w-11 h-11 rounded-2xl bg-white dark:bg-slate-900 shadow-sm ring-1 ring-slate-200 dark:ring-slate-800 flex items-center justify-center text-slate-600 dark:text-slate-400" aria-label="Toggle theme">
      ...
      <button type="button" id="mobile-menu-btn" class="w-11 h-11 rounded-2xl bg-slate-900 dark:bg-white text-white dark:text-slate-900 flex items-center justify-center shadow-lg" aria-label="Menu">
  ...
  <div id="mobile-menu" class="hidden md:hidden bg-white/98 dark:bg-slate-900/98 backdrop-blur-2xl h-screen w-full fixed inset-0 z-[60] flex items-center justify-center">
